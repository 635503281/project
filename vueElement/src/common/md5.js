...
export const str_md5=function(s){ return binl2str(core_md5(str2binl(s), s.length * chrsz));}
...
export const str_hmac_md5=function(key, data) { return binl2str(core_hmac_md5(key, data)); }
