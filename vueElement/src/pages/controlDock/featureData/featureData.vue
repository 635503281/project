...
<template>
    <div>
        ...
        <UploadFile :title="$t('import')" :visible.sync="importDialog" url="ui/featureData/importFeatureData" templateUrl="ui/featureData/downTemplate" @uploadSuccess="getPageData"
...
export default {
    ...
    methods: {
        ...
        async getPageData(plugin={}){
            ...
            const {data}=await this.axios.post("ui/featureData/list",obj);
