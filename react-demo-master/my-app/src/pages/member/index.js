        ...
        return (
            <Layout type={1}>
                <div className='m-members' >
                    ...
                    <EditMember meberMsg={this.rowData} changeState={this.changeState}/>}
                    {this.state.delModel&&
                    <Modal wrapClassName='g-popup-sure' closable={false} title='删除员工' onOk={this.del} onCancel={() => this.setState({delModel:false})} visible={true}>
